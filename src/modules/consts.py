...
# メッセージ種別
SCNMSG_TYPE_UNKNOWN=0
SCNMSG_TYPE_NORMAL=1
SCNMSG_TYPE_TRYGET=2
SCNMSG_TYPE_WHOWADE=3
SCNMSG_TYPE_GETYN=4
SCNMSG_TYPE_ITM2PASS=5
SCNMSG_TYPE_CHKALIGN=6
SCNMSG_TYPE_CHKAUX0=7
SCNMSG_TYPE_BCK2SHOP=8
SCNMSG_TYPE_LOOKOUT=9
SCNMSG_TYPE_RIDDLES=10
SCNMSG_TYPE_FEEIS=11
